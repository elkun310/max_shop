...
class values_product extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('values_product')->insert([
            ...
            ['product_id'=>6,'values_id'=>1],
            ['product_id'=>6,'values_id'=>2],
            ['product_id'=>6,'values_id'=>6],

            ['product_id'=>7,'values_id'=>3],
            ['product_id'=>7,'values_id'=>5],
            ['product_id'=>7,'values_id'=>6],

            ['product_id'=>8,'values_id'=>2],
            ['product_id'=>8,'values_id'=>3],
            ['product_id'=>8,'values_id'=>6],
